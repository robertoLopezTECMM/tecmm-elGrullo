  ...
  render(){
    ...
    return(
      <div className="div-principalMenuCentral">
        ...
        {/*MENU MOVIL*/}
          <div style={styleDrawer} id="mySidenav" class="sidenav">
            ...
            <a>
              ...
              <ul>
                <li>
                  <a href="http://tecmm.edu.mx/#uienesSomos">Quienés Somos</a>
                </li>
        ...
        <a href="/">
          <img className="img-menuCentral-header" src="http://elgrullo.tecmm.edu.mx/imagenes/header.jpg"/>
        </a>
        <img className="img-menuCentral-nombre" src="http://elgrullo.tecmm.edu.mx/imagenes/elGrullo.png"/>
